...
public class testsForLevel3N {
  ...
  //  public class VectorTest1 extends TestCase {
    @Test
        ...
        sphere2.set_emmission(new Color(133, 133, 133));
...
//        scene.addLight(new PointLight(new Color(90, 30, 130), new Point3D(150, -150, -50), 0, 0.00001, 0.000005));
            ...
            ImageWriter imageWriter = new ImageWriter(IMAGES_TEST_DIR + "testPart3_01", 500, 500, 500, 500);
...
*/
        ...
        Sphere sphere1 = new Sphere(150, pSphere1);
        sphere1.set_emmission(new Color(110, 20, 10));
        sphere1.set_material(material);
        scene.addGeometry(sphere1);
...
/*
        public void testPart3_02() {
            ...
            Plane plane = new Plane(new Vector(1,0,0), new Point3D(-100, 0 , 0));
            plane.set_material(15, 0.1, 0.4, 0.2,1);
            plane.set_emmission(new Color(133, 133, 133));
            scene.addGeometry(plane);
